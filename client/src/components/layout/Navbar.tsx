...
export function Navbar() {
  ...
  // Fetch order data for sorting locations
  const orderQuery = useQuery<{ locations: string[] }>({
  ...
  return (
    <>
                          ...
                          {locations.map((loc) => (
                            <li key={loc.id}>
                              <button
                                ...
                                className={`w-full text-left text-white hover:text-gray-300 text-base font-medium py-3 px-2 transition-colors hover:bg-gray-800 rounded-md cursor-pointer ${hoveredLocation === loc.id ? "bg-gray-800" : ""
                                  }`}
                              >
                                {loc.name}
                              </button>
      ...
      {isMenuOpen && (
        ...
        >
          {/* Left Side Transparent Area - Clicking closes menu */}
          <div
            className="flex-grow bg-black/10 backdrop-blur-[2px]"
            onClick={() => setIsMenuOpen(false)}
          />

          {/* Right Side Content Area */}
          <div className="w-[85%] sm:w-[380px] h-full bg-[#f4f4f4] relative flex flex-col shadow-2xl animate-in slide-in-from-right duration-300">

            {/* Close Button */}
            <div className="absolute top-6 right-6 z-10">
              <button
                onClick={() => setIsMenuOpen(false)}
                className="bg-[#e4e4e4] hover:bg-[#d4d4d4] text-black text-[11px] font-bold tracking-widest px-4 py-2 rounded-sm transition-colors uppercase"
              >
                Close
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-8 py-10 no-scrollbar">
              ...
              {/* Navigation Links */}
              <nav className="flex flex-col space-y-5 mb-12">
                <button
                  onClick={() => {
                    scrollToSection("hero");
                    setIsMenuOpen(false);
                  }}
                  className="text-left text-black hover:text-gray-600 text-3xl font-serif leading-tight transition-colors uppercase tracking-tight"
                >
                  Home
                </button>
                ...
                <Link
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <span className="text-left text-black hover:text-gray-600 text-3xl font-serif leading-tight transition-colors uppercase tracking-tight cursor-pointer">
                    About
                  </span>
                </Link>
              ...
              {/* Locations (Keeping functionality) */}
              <div className="mb-10">
                <h3 className="text-[10px] text-gray-400 uppercase tracking-widest mb-3 border-b border-gray-300 pb-1 inline-block">
                  Locations
                </h3>
                <div className="flex flex-col gap-1.5">
                  {locations.map((loc) => (
                    <button
                      ...
                      className="text-left text-gray-600 hover:text-black text-xs font-medium uppercase tracking-wide transition-colors"
                    >
                      {loc.name}
                    </button>
                  ))}
              ...
              <div className="mb-8 space-y-2">
                <a href="mailto:contact@vajramarchitects.com" className="block text-black font-medium text-sm sm:text-base hover:text-gray-600 transition-colors">
                  contact@vajramarchitects.com
                </a>
                <a href="tel:+918886919444" className="block text-black font-medium text-sm sm:text-base hover:text-gray-600 transition-colors">
                  +91 88869 19444
                </a>
              </div>
              ...
              <div className="grid grid-cols-2 gap-y-3 gap-x-4">
                <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-[10px] uppercase font-bold tracking-wider text-black hover:text-gray-600 transition-colors">
                  Instagram
                </a>
                <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-[10px] uppercase font-bold tracking-wider text-black hover:text-gray-600 transition-colors">
                  X / Twitter
                </a>
                <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-[10px] uppercase font-bold tracking-wider text-black hover:text-gray-600 transition-colors">
                  Facebook
                </a>
                <a href="https://wa.me/918886919444" target="_blank" rel="noreferrer" className="text-[10px] uppercase font-bold tracking-wider text-black hover:text-gray-600 transition-colors">
                  WhatsApp
                </a>
              </div>
            </div>
