      ...
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12 sm:space-y-16 md:space-y-20">
            {/* Why Join Us Section */}
            <section>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-serif mb-6 sm:mb-8 text-white border-b border-gray-800 pb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-serif mb-2 text-white">Real-World Experience</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-serif mb-2 text-white">Mentorship</h3>
                    <p className="text-gray-400 leading-relaxed">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-serif mb-2 text-white">Creative Freedom</h3>
                    <p className="text-gray-400 leading-relaxed">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-serif mb-2 text-white">Portfolio Building</h3>
                    <p className="text-gray-400 leading-relaxed">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold font-serif mb-2 text-white">Prepare Your Portfolio</h3>
                      <p className="text-gray-400 leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold font-serif mb-2 text-white">Reach Out to Us</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold font-serif mb-2 text-white">Wait for Our Response</h3>
                      <p className="text-gray-400 leading-relaxed">
            ...
            <section className="border-t border-gray-800 pt-8 sm:pt-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-serif mb-6 sm:mb-8 text-white">
                Get in Touch
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div className="bg-gray-900 border border-gray-800 p-6 sm:p-8 rounded-lg">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-bold font-serif text-white">Email</h3>
                  </div>
                  <a 
                ...
                <div className="bg-gray-900 border border-gray-800 p-6 sm:p-8 rounded-lg">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-xl font-bold font-serif text-white">WhatsApp</h3>
                  </div>
                  <a 
